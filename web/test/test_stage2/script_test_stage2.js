            ...
            ${
                    ...
                    ? `
                        <p class="warningText">
                            ...
                            save ratings in Stage 2 Simulator first.
                        </p>
                    `
                    : `
                        <p class="successText">
                            已使用你保存过的数据
                            <br>
                            Using your saved Stage 2 ratings.
                        </p>
                    `
            }
...
savePickemButton
    .addEventListener("click", () => {
        ...
        localStorage.setItem(
            majorManager.getMajorScopedKey("stage2UserPickem"),
...
// =========================
// 读取 Stage 2 Simulator 保存的评分
//
// 如果没有保存评分：
// 自动使用默认 5 分
// 也就是所有比赛接近 50/50
// =========================
function getSavedStage2Ratings() {
